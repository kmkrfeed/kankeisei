...
async function step_intro(){
  ...
  queueLinesFromBlock(
    "？？：……回答者の接続を確認しました。<br>" +
    "ぼんやりとした視界の中、機械的な音声がはっきりと聞こえた。<br>" +
    ...
    "記録係：{{player}}様は機関の独自調査結果により回答者として選ばれました。<br>" +
    "記録係：真夜中に、誰か一人のことを思考した者。<br>" +
    ...
    "記録係：{{player}}様には十の展示室を順に移動しながら、軸のそれぞれ異なる質問に回答していただきます。<br>" +
    ...
    "記録係：{{player}}様が望むのならば、現在進行形で通話などを行うことも可能でしょう。<br>" +
...
async function step_q1_frequency(){
  ...
  queueLinesFromBlock(
   ...
   "記録係：逆に、{{player}}様の価値観にもよりますが、順路を追うごとに込み入った質問が増えていきます。<br>" +
   ...
   "記録係：ただし、{{player}}様のメッセージを現在の《${STATE.target}》が認識している／認識できる状況にあることを条件とします。<br>" +
   "記録係：現在の《${STATE.target}》が認識できない状況の場合は過去形でお答えください。<br>" +
...
const res = await askChoice(
  `記録係：{{player}}様と《${STATE.target}》は、どの程度の頻度でやり取りしていますか？`,
  [
    // 現在形
...
STATE.timeline = (res.value.startsWith("past_")) ? "past" : "current";
  ...
  queueLinesFromBlock(
    (STATE.timeline==="current")
      ? "記録係：展示に回答を記録いたします。<br>記録係：{{player}}と《${STATE.target}》の関係は現在進行形であると認識しました。<br>記録係：以降は現在形で質問・記録します。<br>記録係：それでは、次の部屋に移動します。<br>記録係：私が誘導しますので順路に従ってお進みください。<br>壁面では先程までと変わらず色鮮やかな写真が流れている。<br>{{player}}はその中の一つに他人ではなく、自分と《${STATE.target}》が写っているものを見つけた。<br>次の部屋へと先導する記録係の後ろで、{{player}}は歩みを進めるのだった。<br>しばらく歩いたのち、記録係が声を発する。<br>記録係：——ご連絡です。第二の部屋に到着いたします。"
      : "記録係：展示に回答を記録いたします。<br>記録係：{{player}}と《${STATE.target}》の関係は過去に属するものであると認識しました。<br>記録係：以降は過去形で質問・記録します。<br>記録係：それでは、次の部屋に移動します。<br>記録係：私が誘導しますので順路に従ってお進みください。<br>壁面を見ると、先程までとは違い、セピア色の古い写真が流れている。<br>{{player}}はさらにその中の一つに他人ではなく、自分と《${STATE.target}》が写っているものを見つけた。<br>次の部屋へと先導する記録係の後ろで、{{player}}は歩みを進めるのだった。<br>しばらく歩いたのち、記録係が声を発する。<br>記録係：——ご連絡です。第二の部屋に到着いたします。"
  );
  await waitQueueEmpty();

  setAnswer("頻度の間","頻度の間","{{player}}様と《"+STATE.target+"》は、どの程度の頻度でやり取りしていますか？", res.label);
  nextStep();
}
// 例：各ステップの最後や refreshChat() の末尾など
preventMobileKeyboard();
...
async function step_q2_valence(){
  ...
  queueLinesFromBlock(
    ...
    "記録係：月《Luna》をもって狂気《Lunatic》を制す、と言うべきでしょうか。<br>" +
   "記録係：さて、そろそろ質問のフェーズに移ります。<br>" +
  ...
  queueLinesFromBlock(
    (STATE.valence==="neg")
      ? "記録係：展示に回答を記録いたします。<br>記録係：{{player}}が《${STATE.target}》に抱く感情に、負の傾向を確認しました。<br>記録係：以降の展示ではこの傾向を前提に質問・記録します。<br>{{player}}が辺りを見れば、先程までと違い、青く凍てついたフラスコが三割増で増えている。<br>今この時もフラスコの中身は変化しているようだ。<br>記録係：それでは、次の部屋に移動します。<br>記録係：私が誘導しますので順路に従ってお進みください。<br>次の部屋へと先導する記録係の後ろで、{{player}}は歩みを進めるのだった。<br>しばらく歩いたのち、記録係が声を発する。<br>記録係：——ご連絡です。第三の部屋に到着いたします。"
      : "記録係：展示に回答を記録いたします。<br>記録係：{{player}}が《${STATE.target}》に抱く感情に、好意的な傾向を全体もしくは一部に確認しました。<br>記録係：以降の展示ではこの傾向を前提に質問・記録します。<br>{{player}}が辺りを見れば、先程までと違い、赤いフラスコと透明なフラスコの数が三割増で増えている。<br>今この時もフラスコの中身は変化しているようだ。<br>記録係：それでは、次の部屋に移動します。<br>記録係：私が誘導しますので順路に従ってお進みください。<br>次の部屋へと先導する記録係の後ろで、{{player}}は歩みを進めるのだった。<br>しばらく歩いたのち、記録係が声を発する。<br>記録係：——ご連絡です。第三の部屋に到着いたします。"
  );
  await waitQueueEmpty();
...
async function step_q3_heart_share(){
  ...
  queueLinesFromBlock(
    ...
    "太陽の下ならばもっと色が映えていたはずだが、強い光はここに無く、夜の闇が辺りを包んでいた。<br>" +
    "しかし、暗い静けさの中でも、花だけが浮き上がっているように見える。<br>" +
    "花の列に終わりはなく、地平線まで続いていた。<br>" +
    "{{player}}から五メートルほど先には、記録係が立っている。<br>" +
    "その傍らには、{{player}}の背丈ほどもある丸い球状のガラスが平べったい台座の上に置かれていた。<br>" +
    ...
    "記録係：今回の質問では、対人感情の領域に{{player}}様自身を含めないと定義いたします。<br>" +
    "記録係：{{player}}様の中にある対人感情。<br>" +
    "記録係：全く別の人に向ける感情もある中で、《${STATE.target}》に向けた感情は{{player}}様の心の内のどれほどを占めているのでしょうか。<br>" +
    "記録係：誰か別の人と共にいても気がつけば《${STATE.target}》のことを考えてしまうようであれば、100%に近いと言えます。<br>" +
    "記録係：逆に、{{player}}様が日々を送る中で全く顔が思い浮かばないのであれば、0%に近いと言えます。<br>" +
    "記録係：しかし、真夜中に《${STATE.target}》のことを考えたからこそ、{{player}}様は当機関に招集されました。<br>" +
    "記録係：完全な0%ということはないでしょう。<br>" +
    "記録係：過去と現在で関係性が変化している場合は、近頃の{{player}}様の状態に基づいての回答をお願いいたします。。<br>" +
    "記録係：また、《${STATE.target}》のことを考える時、{{player}}様はどんな気持ちを抱くでしょうか。<br>" +
    "記録係：柔らかな気持ち。<br>" +
    "記録係：刺々しい気持ち。<br>" +
    "記録係：また、それらとは違う気持ち。<br>" +
    "記録係：{{player}}様の心にある気持ちを表現するのは難しいかもしれませんが、出来る限り言葉にしていただけますと幸いです。<br>" +
    "記録係：それでは、{{player}}様の実情に沿ったものを回答してください。"
  );
  refreshChat();
  await waitQueueEmpty();
...
async function step_q4_comm(){
  ...
  queueLinesFromBlock(
    ...
    "記録係：それは前提となる心持ち・ニュアンスを出来うる限り{{player}}様に共有するためです。<br>" +
    ...
    "記録係：今回の質問では、あくまで{{player}}様の主観に従って答えを出してください。<br>" +
    "記録係：もし今この時に《${STATE.target}》と連絡を取っていたとしても、相手に確認は取らないようにお願いします。<br>" +
    "記録係：{{player}}様が《${STATE.target}》と以心伝心だと思えるのであれば、100%に近いと言えます。<br>" +
    "記録係：逆に、{{player}}様が何を言っても《${STATE.target}》に通じず、{{player}}様が《${STATE.target}》の言っていることを理解できないと思うのであれば、0%に近いと言えます。<br>" +
    "記録係：それでは、{{player}}様の実情に沿ったものを回答してください。"
  );
  refreshChat();
  await waitQueueEmpty();
 ...
 const q = `記録係：あなたは 《${STATE.target}》とどの程度意思疎通ができていると感じていますか？（%）`;
  ...
  queueLinesFromBlock(
    "記録係：展示に回答を記録いたします。<br>" +
    "{{player}}が目の前を見れば、壁に投影された波形が一度静止した後に、新たに全く異なる波形を作り始めた。<br>" +
    "先程の音声を取り込んで波形として表示しているのか。<br>" +
    "それとも全く別の情報を取り込んでいるのか。<br>" +
    "{{player}}には判断がつかなかった。<br>" +
    "記録係：それでは、次の部屋に移動します。<br>" +
    "記録係：私が誘導しますので順路に従ってお進みください。<br>" +
    "次の部屋へと先導する記録係の後ろで、{{player}}は歩みを進めるのだった。<br>" +
    "しばらく歩いたのち、記録係が声を発する。<br>" +
...
async function step_q5_parity(){
  ...
  queueLinesFromBlock(
    ...
    "記録係は{{player}}に傍聴席に座るように、そっと手で促してくる。<br>" +
    "上を見れば、ガラス張りの天井から丸い月が覗いていた。<br>" +
    ...
    "記録係：もし{{player}}様が相手の記録を入手できずとも、ご気分を害されませんようにお願いします。<br>" +
    "記録係：さて、そろそろ質問のフェーズに移ります。<br>" +
    "記録係：今回は選択形式で回答をお願いします。<br>" +
 ...
 const q = `記録係：{{player}}様は《${STATE.target}》を自分と比較してどのような存在だと思っていますか？`;
...
async function step_q6_cooperation(){
  ...
  queueLinesFromBlock(
    ...
    "組み上げれば何らかの装置になりそうだが、何をどう組み上げれば完成するのか、{{player}}にはさっぱり分からないような代物だ。<br>" +
    "上を見れば、ガラス張りの天井から丸い月が覗いていた。<br>" +
    ...
    "記録係：まず、{{player}}様にとっての困難な事象を思い描いてください。<br>" +
    "記録係：それは重大な決定、人生における大一番であると良いでしょう。<br>" +
    "記録係：具体的な困難を思い描いた後に、それを《${STATE.target}》が助力してくれるか、考えてみてください。<br>" +
    "記録係：{{player}}様から見た《${STATE.target}》のイメージでも構いませんので、ご想像をお願いします。<br>" +
    "記録係：それでは、{{player}}様の実情に沿ったものを回答してください。"
 ...
 let q, opts;
  ...
  queueLinesFromBlock(
    ...
    "アームは次々に部品を弄り始めたが、それが分解にあたるのか、組み立てにあたるのかは{{player}}には分からなかった。<br>" +
    "記録係：それでは、次の部屋に移動します。<br>" +
    "記録係：私が誘導しますので順路に従ってお進みください。<br>" +
    "次の部屋へと先導する記録係の後ろで、{{player}}は歩みを進めるのだった。<br>" +
    "しばらく歩いたのち、記録係が声を発する。<br>" +
...
async function step_q7_influence(){
  ...
  queueLinesFromBlock(
    ...
    "記録係：今回の質問でも、あくまで{{player}}様の主観に従っていただきますようお願いします。<br>" +
    "記録係：{{player}}様が《${STATE.target}》から人生を百八十度変えるほどの影響を受けたのならば、100%に近いと言えます。<br>" +
...
async function step_q8_respect(){
  ...
  queueLinesFromBlock(
    ...
    "しかし、{{player}}が肖像画に近づくとその輪郭はぼやけていく。<br>" +
    "一際大きな肖像画の前で、記録係は足を止めた。<br>" +
    "その肖像画は背景が黄色一色に塗られている。<br>" +
    "輪郭は他と同じようにぼやけていて、{{player}}にはどんな顔なのかよく捉えられなかった。<br>" +
    "上を見れば、ガラス張りの天井から丸い月が覗いていた。<br>" +
    ...
    "記録係：これまでの質問で「自分より下」などの回答をされていた方でも、わずかにでも《${STATE.target}》を良いと感じていることもあるでしょう。<br>" +
    "記録係：逆に、これまでの質問で「自分より上」などの回答をされていた方でも、《${STATE.target}》を良いと感じていないこともあるでしょう。<br>" +
...
async function step_q9_trust(){
  ...
  queueLinesFromBlock(
    ...
    "列を成す膨大な金庫は迫り来る壁の様にすら感じる。<br>" +
    "置かれている金庫の種類はダイヤル式、鍵式のものもあれば、開け方に見当がつけられない形式のものもある。<br>" +
    "その中の一つ、{{player}}の目線に近いところに置かれた鍵式の金庫の前で、記録係は足を止めた。<br>" +
    "上を見れば、ガラス張りの天井から丸い月が覗いていた。<br>" +
    ...
    "記録係：まず、{{player}}様が抱く秘密について挙げてください。<br>" +
    "記録係：それは重大な秘密・決意、{{player}}様の人生の根幹・転機に関わるものであると良いでしょう。<br>" +
  ...
  if(STATE.valence==="neg"){
    q = (STATE.timeline==="past")
      ? `記録係：当時の{{player}}様はその秘密を《${STATE.target}》に打ち明けたいと考えていましたか？`
      : `記録係：{{player}}様はその秘密を《${STATE.target}》に打ち明けたいと思いますか？`;
...
async function step_q10_sustain(){
  ...
  queueLinesFromBlock(
    ...
    "{{player}}がフォルダの一つを見れば、ページの端に緑・黄・赤・黒のインデックスラベルが付けられていた。<br>" +
    "記録係は奥の椅子に先に座り、{{player}}に手前の椅子に座るように手で促す。<br>" +
    ...
    "記録係：自由回答のみ、もしくは選択式回答の後に自由回答をお願いすることになります。<br>" +
    "記録係：第十の質問は、{{player}}様と《${STATE.target}》の関係性の継続・断絶についてです。<br>" +
    "記録係：《${STATE.target}》との関係性が現在も進行している回答者には、関係を今後も続けたいか、お訊きします。<br>" +
    "記録係：そして、その答えを出した理由についてもご回答いただけますと幸いです。<br>" +
    "記録係：《${STATE.target}》との関係性が過去である回答者には、関係が何故続かなくなったのか、お尋ねします。<br>" +
    "記録係：回答内容は自由に、{{player}}様の主観で構いません。<br>" +
    "記録係：《${STATE.target}》と{{player}}様自身を見つめ直して、言葉で紡いでください。<br>" +
    "記録係：それでは、{{player}}様の実情に沿ったものを回答してください。"
...
async function step_exit(){
  ...
  queueLinesFromBlock(
    ...
    "{{player}}のいるところから数メートル先を行きながら、記録係は声を発した。<br>" 
  );

  let line="";
  if(STATE.timeline==="current" && STATE.valence!=="neg"){
    line = "記録係：現在、今までの回答を保存し、出力できるように準備中です。<br>記録係：{{player}}様と《"+STATE.target+"》の関係は、なお継続中と認識されました。<br>記録係：継続的な関係は、当機関にとって今後も重要な観測対象です。<br>記録係：今回の回答作業が、{{player}}様にとって再認識の機会となっていましたら幸いです。";
  }else if(STATE.timeline==="past" && STATE.valence!=="neg"){
    line = "記録係：現在、今までの回答を保存し、出力できるように準備中です。<br>記録係：{{player}}様と《"+STATE.target+"》の関係は、既に終了したものであると認識されました。<br>記録係：しかし残された記録は、貴重な標本です。<br>記録係：当機関にとっても。<br>記録係：おそらくは{{player}}様にとっても。<br>記録係：今回の回答作業が、{{player}}様にとって良い機会となっていましたら幸いです。";
  }else if(STATE.timeline==="current" && STATE.valence==="neg"){
    line = "記録係：現在、今までの回答を保存し、出力できるように準備中です。<br>記録係：{{player}}様と《"+STATE.target+"》の関係は、負の感情を帯びながらも継続中であると認識されました。<br>記録係：それが効率的ではない関係だとしても、故にこそ認められる特異性もあるでしょう。<br>記録係：今回の回答作業が、{{player}}様にとって再認識の機会となっていましたら幸いです。";
  }else{
    line = "記録係：現在、今までの回答を保存し、出力できるように準備中です。<br>記録係：{{player}}様と《"+STATE.target+"》の関係は、負の感情を残したまま終了したと認識されました。<br>記録係：個々人により異なりますが、断絶を感じて痛みを覚える方もいるでしょう。<br>記録係：複雑な感情を伴う関係性は、言語で整理することにより客観視出来る場合もあります。<br>記録係：今回の回答作業が、{{player}}様にとって良い機会となっていましたら幸いです。";
  }
  ...
  queueLinesFromBlock(
    ...
    "先の見えない白い光が、薄暗さに慣れていた{{player}}の目には眩しい。<br>" +
    "ゲートの傍らで記録係は足を止め、{{player}}に向けてゆっくりと振り返る。<br>" +
    "記録係：最後に、少しだけ{{player}}様のお時間をいただいてよろしいでしょうか。<br>" +
    ...
    "記録係：関係性とは元々流動的なものとなるのですから。<br>" +
    "記録係：……ここまで長らくお付き合いいただき、ありがとうございました。<br>" +
    "記録係：今後、{{player}}様の関係性に変化が生まれたり、別の人のことを考えたりした時。<br>" +
    "記録係：もしかしたら再び、当機関に招集されることがあるかもしれません。<br>" +
    "記録係：{{player}}様にその時が訪れましたら、またよろしくお願いいたします。<br>" +
    "記録係：今後も、月の見える真夜中にお会いできれば光栄です。<br>" +
    "{{player}}が上を見れば、ガラス張りの天井から丸い月が覗いている。<br>" +
    "月は何も変わらず、物言わず、ただ僅かな光を暗い空から与え続けていた。<br>" +
