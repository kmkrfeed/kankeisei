...
async function step_q3_heart_share(){
  ...
  queueLinesFromBlock(
    ...
    "しかし、暗い静けさの中でも、花の色が際立っているように見える。<br>" +
...
async function step_exit(){
  ...
  if(STATE.timeline==="current" && STATE.valence!=="neg"){
    ...
    line = "記録係：現在、今までの回答を保存し、出力できるように準備中です。<br>記録係：{{player}}様と《"+STATE.target+"》の関係は、既に終了したものであると認識されました。<br>記録係：しかし残された記録は、貴重な標本です。<br>記録係：当機関にとっても。<br>記録係：おそらくはあなたにとっても。<br>記録係：今回の回答作業が、あなたにとって良い機会となっていましたら幸いです。";
  }else if(STATE.timeline==="current" && STATE.valence==="neg"){
